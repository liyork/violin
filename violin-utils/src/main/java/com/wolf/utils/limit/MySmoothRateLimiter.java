...
@GwtIncompatible
abstract class MySmoothRateLimiter extends MyRateLimiter {
    /*
     ...
     * </ul>
     */
    static final class MySmoothWarmingUp extends MySmoothRateLimiter {
     ...
     */
    static final class MySmoothBursty extends MySmoothRateLimiter {
        /**
         * The work (permits) of how many seconds can be saved up if this RateLimiter is unused?
         */
        final double maxBurstSeconds;

        MySmoothBursty(SleepingStopwatch stopwatch, double maxBurstSeconds) {
            super(stopwatch);
        ...
        void doSetRate(double permitsPerSecond, double stableIntervalMicros) {
            ...
            System.out.println(Thread.currentThread() + " doSetRate, maxPermits:" + maxPermits + ", storedPermits:" + storedPermits);
        }
    ...
    private MySmoothRateLimiter(SleepingStopwatch stopwatch) {
        super(stopwatch);
    }
    ...
    final long reserveEarliestAvailable(int requiredPermits, long nowMicros) {
        ...
        System.out.println(Thread.currentThread() + " reserveEarliestAvailable, returnValue:" + returnValue +
                ", requiredPermits:" + requiredPermits + ", storedPermits:" + storedPermits +
                ", storedPermitsToSpend:" + storedPermitsToSpend + ", freshPermits:" + freshPermits);
        long waitMicros =
        ...
        System.out.println(Thread.currentThread() + " reserveEarliestAvailable" +
                ", waitMicros:" + waitMicros + ", end_nextFreeTicketMicros:" + nextFreeTicketMicros +
                ", storedPermits:" + storedPermits + ", stableIntervalMicros:" + stableIntervalMicros);
        return returnValue;
    }
    ...
    void resync(long nowMicros) {
        ...
        if (nowMicros > nextFreeTicketMicros) {
            ...
            System.out.println(Thread.currentThread() + " resync nowMicros > nextFreeTicketMicros, nowMicros:" +
                    nowMicros + ", nextFreeTicketMicros:" + nextFreeTicketMicros + ", newPermits:" + newPermits +
                    ", storedPermits:" + storedPermits);
        } else {
            System.out.println(Thread.currentThread() + " resync nowMicros <= nextFreeTicketMicros, nowMicros:" +
                    nowMicros + ", nextFreeTicketMicros:" + nextFreeTicketMicros +
                    ", storedPermits:" + storedPermits);
        }
    }
}
