...
//    = Logger.getLogger(SerializerFactory.class.getName());
	...
	protected static final Logger log = LoggerFactory.getLogger(SerializerFactory.class);
...
//      log.log(Level.FINEST, e.toString(), e);
			...
			throws HessianProtocolException
	{
		...
		if (log.isInfoEnabled())  {
			log.info("hessian: expected deserializer '" + cl.getName() + "' at '" + type + "' ("
			...
			throws HessianProtocolException
	{
		...
		if (log.isInfoEnabled()) {
			log.info("hessian: expected '" + cl.getName() + "' at '" + type + "' ("
					+ reader.getType().getName() + ")");
		}
			...
			throws HessianProtocolException
	{
		...
		if (type.startsWith("[")) {
			...
			try {
				...
				log.warn("Hessian/Burlap: '" + type + "' is an unknown class in " + _loader + ":\n" + e);
