...
public class Retmsg extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Retmsg\",\"namespace\":\"com.wolf.test.avro.generateclass\",\"fields\":[{\"name\":\"msg\",\"type\":\"string\"}]}");
  ...
  public static com.wolf.test.avro.generateclass.Retmsg.Builder newBuilder() {
    return new com.wolf.test.avro.generateclass.Retmsg.Builder();
  }
  
  /** Creates a new Retmsg RecordBuilder by copying an existing Builder */
  public static com.wolf.test.avro.generateclass.Retmsg.Builder newBuilder(com.wolf.test.avro.generateclass.Retmsg.Builder other) {
    return new com.wolf.test.avro.generateclass.Retmsg.Builder(other);
  }
  
  /** Creates a new Retmsg RecordBuilder by copying an existing Retmsg instance */
  public static com.wolf.test.avro.generateclass.Retmsg.Builder newBuilder(com.wolf.test.avro.generateclass.Retmsg other) {
    return new com.wolf.test.avro.generateclass.Retmsg.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Retmsg>
    ...
    private Builder() {
      super(com.wolf.test.avro.generateclass.Retmsg.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.wolf.test.avro.generateclass.Retmsg.Builder other) {
      super(other);
    ...
    private Builder(com.wolf.test.avro.generateclass.Retmsg other) {
            super(com.wolf.test.avro.generateclass.Retmsg.SCHEMA$);
      if (isValidValue(fields()[0], other.msg)) {
        this.msg = data().deepCopy(fields()[0].schema(), other.msg);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'msg' field */
    public com.wolf.test.avro.generateclass.Retmsg.Builder setMsg(java.lang.CharSequence value) {
    ...
    public com.wolf.test.avro.generateclass.Retmsg.Builder clearMsg() {
      msg = null;
