...
public class Members extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Members\",\"namespace\":\"com.wolf.test.avro.generateclass\",\"fields\":[{\"name\":\"userName\",\"type\":\"string\"},{\"name\":\"userPwd\",\"type\":\"string\"},{\"name\":\"realName\",\"type\":[\"string\",\"null\"]}]}");
  ...
  public static com.wolf.test.avro.generateclass.Members.Builder newBuilder() {
    return new com.wolf.test.avro.generateclass.Members.Builder();
  }
  
  /** Creates a new Members RecordBuilder by copying an existing Builder */
  public static com.wolf.test.avro.generateclass.Members.Builder newBuilder(com.wolf.test.avro.generateclass.Members.Builder other) {
    return new com.wolf.test.avro.generateclass.Members.Builder(other);
  }
  
  /** Creates a new Members RecordBuilder by copying an existing Members instance */
  public static com.wolf.test.avro.generateclass.Members.Builder newBuilder(com.wolf.test.avro.generateclass.Members other) {
    return new com.wolf.test.avro.generateclass.Members.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Members>
    ...
    private Builder() {
      super(com.wolf.test.avro.generateclass.Members.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.wolf.test.avro.generateclass.Members.Builder other) {
      super(other);
    ...
    private Builder(com.wolf.test.avro.generateclass.Members other) {
            super(com.wolf.test.avro.generateclass.Members.SCHEMA$);
      if (isValidValue(fields()[0], other.userName)) {
        this.userName = data().deepCopy(fields()[0].schema(), other.userName);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'userName' field */
    public com.wolf.test.avro.generateclass.Members.Builder setUserName(java.lang.CharSequence value) {
    ...
    public com.wolf.test.avro.generateclass.Members.Builder clearUserName() {
      userName = null;
    ...
    /** Sets the value of the 'userPwd' field */
    public com.wolf.test.avro.generateclass.Members.Builder setUserPwd(java.lang.CharSequence value) {
    ...
    public com.wolf.test.avro.generateclass.Members.Builder clearUserPwd() {
      userPwd = null;
    ...
    /** Sets the value of the 'realName' field */
    public com.wolf.test.avro.generateclass.Members.Builder setRealName(java.lang.CharSequence value) {
    ...
    public com.wolf.test.avro.generateclass.Members.Builder clearRealName() {
      realName = null;
