...
public class SnmpTrapSender {
    ...
    public void init() throws IOException {
        //目标主机的ip地址 和 端口号
        targetAddress = GenericAddress.parse("udp:localhost/162");
    ...
    public ResponseEvent sendV1Trap() throws IOException {
        ...
        // set target
        CommunityTarget target = SnmpUtils.createTarget("localhost", "public", SnmpConstants.version1);
    ...
    public ResponseEvent sendV2cTrap() throws IOException {
        ...
        // set target
        CommunityTarget target = SnmpUtils.createTarget("localhost", "public", SnmpConstants.version2c);
        // send pdu, return response
        return snmp.send(pdu, target);
    }
