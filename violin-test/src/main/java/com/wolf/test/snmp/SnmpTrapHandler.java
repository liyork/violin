...
public class SnmpTrapHandler implements CommandResponder {
    ...
    private static String ipAddress = "udp:localhost/1622";
    ...
    public void start() {
        init();
        //将当前对象添加至commandResponderListeners中
    ...
    public void processPdu(CommandResponderEvent event) {
        ...
        System.out.println("接收到的trap信息：[发送来源=" + event.getPeerAddress() + ",snmp版本=" + version +
                ",团体名=" + community + ", 携带的变量=" + event.getPDU().getVariableBindings() + "]");
    }

    // snmptrap -v2c -c public localhost:1622 '' .1.3.6.1.2.1.1
